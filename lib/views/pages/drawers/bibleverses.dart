...
import 'package:triumph_ministry/views/pages/drawers/versedetail.dart';
...
class BibleversesPage extends StatefulWidget {
  const BibleversesPage({Key? key}) : super(key: key);
                                ...
                                Container(
                                  ...
                                  child: InkWell(
                                    onTap: (){
                                      ...
                                      builder: (BuildContext context) => const VerseDetailPage(),));
                                    },
                                    child: Row(
                                      children: [
