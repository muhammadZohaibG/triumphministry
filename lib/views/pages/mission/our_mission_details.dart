...
class OurMissionDetails extends StatefulWidget {
  const OurMissionDetails({Key? key}) : super(key: key);

  @override
  State<OurMissionDetails> createState() => _OurMissionDetailsState();
}

class _OurMissionDetailsState extends State<OurMissionDetails> {
  @override
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('Teach Children', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),),
                        Container(
                          height: 30,
                          width: 75,
                          decoration: BoxDecoration(
